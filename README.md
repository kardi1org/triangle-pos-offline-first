...
-   run `rm -r public/storage` atau `rm public/storage -Force`<-- Jika mau unlink storage
...
Using version ^4.1 for rawilk/laravel-printing

1. Menginstal paket melalui composer:
   di Terminal jalankan script : composer require rawilk/laravel-printing

-   Installing mike42/gfx-php (v0.6): Extracting archive
-   Installing spatie/laravel-package-tools (1.92.4): Extracting archive
-   Installing mike42/escpos-php (v4.0): Extracting archive
-   Installing rawilk/laravel-printing (v4.1.0): Extracting archive

2. Menerbitkan berkas konfigurasi dengan:
