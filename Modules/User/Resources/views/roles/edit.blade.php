                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="access_budgets" name="permissions[]"
                                                            value="access_budgets"
                                                            {{ $role->hasPermissionTo('access_budgets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="access_budgets">Access</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="create_budgets" name="permissions[]"
                                                            value="create_budgets"
                                                            {{ $role->hasPermissionTo('create_budgets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="create_budgets">Create</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="edit_budgets" name="permissions[]" value="edit_budgets"
                                                            {{ $role->hasPermissionTo('edit_budgets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="edit_budgets">Edit</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="delete_budgets" name="permissions[]"
                                                            value="delete_budgets"
                                                            {{ $role->hasPermissionTo('delete_budgets') ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="delete_budgets">Delete</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
