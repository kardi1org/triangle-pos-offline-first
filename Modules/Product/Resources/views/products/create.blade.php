                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_cost" type="number" class="form-control" name="product_cost"
                                            min="0" step="0.01" required value="{{ old('product_cost') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_price" type="number" class="form-control" name="product_price"
                                            min="0" step="0.01" required value="{{ old('product_price') }}">
                                    </div>
                                </div>
                            </div>
