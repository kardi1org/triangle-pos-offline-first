                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_cost" type="number" class="form-control" min="0"
                                            name="product_cost" min="0" step="0.01" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_price" type="number" class="form-control" min="0"
                                            name="product_price" min="0" step="0.01" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="is_recipe" id="is_recipe" required>
                                            <option value="N"
                                                {{ (old('is_recipe') ?? $product->is_recipe) == 'N' ? 'selected' : '' }}>
                                                No (N)
                                            </option>
                                            <option value="Y"
                                                {{ (old('is_recipe') ?? $product->is_recipe) == 'Y' ? 'selected' : '' }}>
                                                Yes (Y)
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_type" id="product_type" required>
                                            <option value="FG"
                                                {{ old('product_type', $product->product_type) == 'FG' ? 'selected' : '' }}>
                                                FG (Finished Goods)</option>
                                            <option value="Material"
                                                {{ old('product_type', $product->product_type) == 'Material' ? 'selected' : '' }}>
                                                Material</option>
                                        </select>
                                    </div>
                                </div>
