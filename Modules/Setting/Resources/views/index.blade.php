                    ...
                    <div class="card-body">
                        <form action="{{ route('settings.update') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="is_shift">Shift <span class="text-danger">*</span></label>
                                        <select name="is_shift" id="is_shift" class="form-control" required>
                                            <option {{ $settings->is_shift == 'aktif' ? 'selected' : '' }} value="aktif">
                                                AKTIF</option>
                                            <option
                                                {{ $settings->is_shift == 'tidak aktif' || !$settings->is_shift ? 'selected' : '' }}
