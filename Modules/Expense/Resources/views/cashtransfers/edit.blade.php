...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('cashtransfer.edit') }}">Cash Transfer</a></li>
...
@section('content')
    <div class="container-fluid">
        <form id="expense-form" action="{{ route('cashtransfer.update', $expense) }}" method="POST">
            @csrf
            @method('patch')
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Update Cash Transfer <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="receive_type_from" id="receive_type_from" class="form-control" required>
                                            <option value="" selected>Receive Type</option>
                                            @foreach(\Modules\MethodePay\Entities\MethodePay::all() as $methode)
                                                ...
                                                <option {{ $methode->methode_name == $expense->receive_type_transferfrom ? 'selected' : '' }} value="{{ $methode->methode_name }}">{{ $methode->methode_name }}</option>
                                            @endforeach 
                                        </select>
                                    </div>
                                </div> 
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {{-- <input id="amount_transfer_from" type="text" class="form-control" name="amount_transfer_from" required
                                        value="{{ $expense->amount_transferfrom }}"> --}}
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="transtype" id="transtype" class="form-control" required>
                                              ...
                                              {{-- <option {{ $methode->methode_name == $expense->trans_type ? 'selected' : '' }} 
                                                value="{{ $methode->methode_name }}">{{ $methode->methode_name }}</option> --}}
                                        </select>
                                    </div>
                                </div> 
                                <div class="col-lg-6">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="receive_type_to" id="receive_type_to" class="form-control" required>
                                            ...
                                            @foreach(\Modules\MethodePay\Entities\MethodePay::all() as $methode)
                                                {{-- <option value="{{ $methode->methode_name }}">{{ $methode->methode_name }}</option> --}}
                                                <option {{ $methode->methode_name == $expense->receive_type_transferto ? 'selected' : '' }} value="{{ $methode->methode_name }}">{{ $methode->methode_name }}</option>
                                            @endforeach  
                                        </select>
                                    </div>
                                </div> 
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {{-- <input id="amount_transfer_to" type="text" class="form-control" name="amount_transfer_to" required
                                        value="{{ $expense->amount_transferto }}"> --}}
                                        <input type="number" id="amount_transfer_to" class="form-control" name="amount_transfer_to"
                                          onblur="if (this.value == '') {this.value = 0;}"
                                          onfocus="if (this.value == 0) {this.value = '';}"
                                          value="{{ $expense->amount_transferto }}" required readonly="true">
                                    </div>
                                </div>
                            </div>
