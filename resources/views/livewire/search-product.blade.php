<div class="position-relative">
        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input wire:keydown.escape="resetQuery" wire:model.live.debounce.100ms="query" type="text"
                        class="form-control" placeholder="Product name or code....">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    <input type="text" class="form-control" wire:model="query" wire:keydown.escape="closeErrorModal"
                        wire:keydown.enter="selectFirstResult" placeholder="Scanner...." autofocus>
                </div>
            </div>
        </div>
    </div>
    ...
    @if (!empty($query))
        ...
        @endif
    @elseif(!empty($query))
        @if ($search_barcodes->isNotEmpty())
            <div class="card position-absolute mt-1" style="z-index: 2;left: 0;right: 0;border: 0;">
                <div class="card-body shadow">
                    <ul class="list-group list-group-flush">
                        @foreach ($search_barcodes as $cart_item)
                            <li class="list-group-item list-group-item-action">
