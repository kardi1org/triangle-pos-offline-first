    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <div class="form-group d-flex justify-content-center flex-wrap mb-0">
                {{-- --------------------------Add by Chris------------------------- --}}
                {{-- <button wire:click="saveOrder" type="submit" value="save" class="btn btn-pill btn-primary"><i class="bi bi-check"></i> Save Order</button>&nbsp;&nbsp;&nbsp;&nbsp; --}}
                <button onclick="saveOrder()" type="submit" value="save" class="btn btn-pill btn-primary"><i
                        class="bi bi-check"></i> Save Order</button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="getdatacart()" type="submit" class="btn btn-pill btn-primary"><i
                        class="bi bi-check"></i> Get Data</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                {{-- <button wire:click="getdatacart()" type="submit" class="btn btn-pill btn-primary"><i class="bi bi-check"></i> Get Data</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --}}
                {{-- --------------------------------------------------------------- --}}
