                        ...
                        <tbody>
                            @forelse($sales as $sale)
                                <tr>
                                    ...
                                    <td>{{ format_currency($sale->total_amount) }}</td> {{-- nilainya belum sesuai dgn yang ditabel  --}}
                                    <td>{{ format_currency($sale->paid_amount) }}</td> {{-- nilainya belum sesuai dgn yang ditabel  --}}
                                    <td>{{ format_currency($sale->due_amount) }}</td> {{-- nilainya belum sesuai dgn yang ditabel  --}}
                                    <td>
